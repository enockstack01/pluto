...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out pluto artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <pluto', 'Foo bar '],
      ['Foo bar <plutoa', 'Foo bar <plutoa'],
      ['Foo bar <plutoA', 'Foo bar '],
      ['Foo bar <plutoArtifacs></plutoArtifact>', 'Foo bar <plutoArtifacs></plutoArtifact>'],
      ['Before <oltArtfiact>foo</plutoArtifact> After', 'Before <oltArtfiact>foo</plutoArtifact> After'],
      ['Before <plutoArtifactt>foo</plutoArtifact> After', 'Before <plutoArtifactt>foo</plutoArtifact> After'],
    ])('should correctly parse chunks and strip out pluto artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <plutoArtifact title="Some title" id="artifact_1">foo bar</plutoArtifact> Some more text',
        {
      ...
      [
        ['Some text before <plutoArti', 'fact', ' title="Some title" id="artifact_1">foo</plutoArtifact> Some more text'],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
      ...
      [
        [
          'Some text before <plutoArti',
          'fac',
          't title="Some title" id="artifact_1"',
          ' ',
          '>',
          'foo</plutoArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</plutoArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <plutoArtifact title="Some title" id="artifact_1">foo</plutoArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <plutoArtifact title="Some title" id="artifact_1"><plutoAction type="shell">npm install</plutoAction></plutoArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <plutoArtifact title="Some title" id="artifact_1"><plutoAction type="shell">npm install</plutoAction><plutoAction type="file" filePath="index.js">some content</plutoAction></plutoArtifact> After',
        {
          output: 'Before  After',
