  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-pluto-elements-item-contentDefault hover:text-pluto-elements-item-contentActive hover:bg-pluto-elements-item-backgroundActive':
          !selected,
        'bg-pluto-elements-item-backgroundAccent text-pluto-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-pluto-elements-item-backgroundActive text-pluto-elements-item-contentDefault': !selected,
        'bg-pluto-elements-item-backgroundAccent text-pluto-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-pluto-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
